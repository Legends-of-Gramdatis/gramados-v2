...
var MARKET_NPC_CONFIG = "world/customnpcs/scripts/ecmascript/modules/markets/market_npc_config.json";
...
function processPlayerDelivery(npc, player, item) {
    ...
    if (containerInfo.type === "crate") {
        processCrateDelivery(player, item, containerInfo);
        return;
    }
...
function processCrateDelivery(player, item, containerInfo) {
    npc.say(ccs("&eLet me see what you have in that " + containerInfo.displayName + "..."));
