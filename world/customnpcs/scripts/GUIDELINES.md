# Gramados Custom NPC Scripts Guide
...
Remember, consistency in style helps everyone. Follow the patterns already in the repo’s existing docs. The main `README.md` at the root and other `.md` files are good examples of tone and formatting.
